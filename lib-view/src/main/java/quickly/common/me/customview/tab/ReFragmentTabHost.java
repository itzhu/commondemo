package quickly.common.me.customview.tab;
 ...
 * <p>
 * <p>
 * 参考{@link android.support.v4.app.FragmentTabHost}
 * {@see <a href="http://download.csdn.net/detail/yalinfendou/8538703">查看原文</a>}
 * 添加的fragment不会重新onViewCreated,切换fragment时，fragment会执行onViewHidden
 */
public class ReFragmentTabHost extends TabHost implements
    ...
    public ReFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
